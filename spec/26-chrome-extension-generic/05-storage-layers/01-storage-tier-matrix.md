...
Provide the 4-tier comparison table: tier, technology, scope, capacity, persistence across reinstall/clear, intended use, anti-patterns. This is the decision tool when picking where to store data.
