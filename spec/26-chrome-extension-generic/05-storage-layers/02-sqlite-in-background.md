...
Document running sqlite-wasm in the MV3 service worker: bundle vs runtime download, OPFS opt-in, WASM checksum validation, lifecycle (open on activation, close on suspend), connection management.

---

## Source material to distill (private — do NOT cite in final body)

`scripts/compute-wasm-checksum.mjs`, `docs/diagrams/sqlite-runtime-erd.mmd`, `docs/diagrams/sqlite-bundle-erd.mmd`
