...
When to use IndexedDB vs SQLite (page-side per-origin caches), the dual-cache pattern (e.g., JsonCopy + HtmlCopy), schema versioning, and IDB error recovery.

---

## Source material to distill (private — do NOT cite in final body)

mem://features/prompt-management, `src/content-scripts/`
