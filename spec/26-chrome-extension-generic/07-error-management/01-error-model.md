...
Define the canonical AppError TypeScript shape: { code, severity, path?, missing?, reason, timestamp, stack, context? }. Provide constructor helpers and serialisation rules for cross-world transport.

---

## Source material to distill (private — do NOT cite in final body)

`src/types/error-model.ts`, mem://standards/error-logging-requirements
