...
Define the SCREAMING_SNAKE_CASE code policy with module prefix (e.g., TOKEN-SEEDER_ERROR, STORAGE_QUOTA_EXCEEDED, INJECTION_FAILED). Provide an allocation registry table with a starter set every extension can adopt.
